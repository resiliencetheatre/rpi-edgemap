...
<div class="log-window" id="log-window">
			...
			<div style="display: table;">
				<div style="display: table-row; width:100%;">
					<div style="display: table-cell;">
						<i data-feather="at-sign" class="feather-callSignInput"></i>
					</div>
					<div style="display: table-cell; width:100%;">
						<input id="myCallSign" type="text" class="callSignInput" maxlength="5" >
					</div>
				</div>
			</div>
			...
			<div style="display: table;">
				<div style="display: table-row; width:100%;">
					<div style="display: table-cell;">
						...
						<i data-feather="map-pin" class="feather-cmdButtons" onClick='createNewDragableMarker();'></i>
						
						<i data-feather="trash" class="feather-cmdButtons" onClick='eraseMsgLog();' ></i>
					</div>
				</div>
			</div>
	...
	<input type="text" id="msgInput" type="text" style="width: 78%" >
...
<script>
	...
	*/
	...
	function createNewDragableMarker() {
		// createMarker(mapDragableMarkerCount); 	// option 1
		// mapDragableMarkerCount++;				// option 1
	...
	window.onload = function() {
		...
		msgSocket.onmessage = function(event) {
			...
			if ( trimmedString.startsWith($('#myCallSign').value) == true ) {
				...
				logDiv.style.display = "block"; // open log window
	...
	*/
	...
	//
	// Animation sample from maplibre examples:
	//
