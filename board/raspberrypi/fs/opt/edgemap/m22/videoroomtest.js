						...
						janus.attach(
							{
								...
								success: function(pluginHandle) {
									...
									// Prepare the username registration (disable user entry)
									/*
									...
									*/
									// Random Username
									var a = ["Small", "Blue", "Nice", "Operation", "Brown", "Easy", "Dragoon"];
									var b = ["Bear","Dragoon", "Dog", "Redemption","Prodigy"];
									...
									$('#start').removeAttr('disabled').html("Leave")
										.click(function() {
			...
			onmessage: function(msg, jsep) {
				...
				if(msg["error"]) {
					...
					if(event === "attached") {
						...
						// if remoteFeed.rfdisplay == 'host' => remoteFeed.rfindex = 0
						if ( remoteFeed.rfdisplay == 'host' ) {
